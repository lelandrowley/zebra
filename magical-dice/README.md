...
- **Eighteen stones.** Amethyst, ruby, emerald, sapphire, sea glass, obsidian,
  opal, moonstone, pearl, nebula, marble, granite, lapis, jade, gold, silver,
  copper and bone — built on physically-based transmission, iridescence,
  clearcoat and emissive starfields. Or flip on **Motley set** to give every die
  its own stone.
...
- **Sound, synthesized.** Clacks pitched by die size and a pentatonic settle
  chime, all generated in WebAudio — no audio files. Mutable under Fate.
...
panel: **Dice** (loadout + presets), **Style** (stones), **Type** (numerals),
